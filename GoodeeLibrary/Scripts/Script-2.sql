...
VALUES(BOOK_SEQ.NEXTVAL, 'a', 'a', 'a', 'a', sysdate, 'a', 'asd15000', 15000, 'Y');

ALTER TABLE BOOK MODIFY THUMBNAIL VARCHAR2(200);
ALTER TABLE BOOK MODIFY PUBLISHER VARCHAR2(200);	
ALTER TABLE BOOK MODIFY TITLE VARCHAR2(200);	
ALTER TABLE BOOK MODIFY AUTHORS VARCHAR2(200);	
ALTER TABLE BOOK MODIFY ISBN VARCHAR2(200);	
